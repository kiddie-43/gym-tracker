...
internal static class MeasurementTypesTestHost
{
    ...
    private sealed class InMemoryMeasurementTypeRepository : IMeasurementTypeRepository
    {
        ...
        private static (string Key, string Name, string Unit, string DataType, string Category, string? Description) NormalizeRequest(
            UpsertMeasurementTypeRequest request)
        {
