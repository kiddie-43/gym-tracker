...
public sealed class MeasurementTypesEndpointsTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public MeasurementTypesEndpointsTests(WebApplicationFactory<Program> factory)
    {
