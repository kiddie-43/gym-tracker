...
export const setPreferencesHeaderShowBackButton = createAction<boolean>('preferences/setHeaderShowBackButton');
export const requestPreferencesHeaderBack = createAction('preferences/requestHeaderBack');
